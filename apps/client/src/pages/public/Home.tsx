		...
		<div className="flex flex-col gap-6 p-8">
			...
			<section className="flex flex-col gap-2">
				...
				<div className="flex flex-col gap-1">
					...
					<Button
						nativeButton={false}
						render={<Link to="/register/agency">Register as agency</Link>}
						variant="outline"
					/>
					<Button
						nativeButton={false}
						render={<Link to="/verify-email/request">Verify email (needs token)</Link>}
						variant="outline"
					/>
				</div>
			</section>
			...
			<section className="flex flex-col gap-2">
				...
				<div className="flex flex-col gap-1">
					...
					<Button
						nativeButton={false}
						render={<Link to="/no-agency">No agency (create prompt)</Link>}
						variant="outline"
					/>
					<Button
						nativeButton={false}
						render={<Link to="/agency/new">Create agency</Link>}
						variant="outline"
					/>
					<Button
						nativeButton={false}
						render={<Link to="/accept-invitation/test-id">Accept invitation (test)</Link>}
						variant="outline"
					/>
				</div>
			</section>
